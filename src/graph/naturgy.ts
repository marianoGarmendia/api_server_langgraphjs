  ...
  async ({ alcaldia, calle, colonia, numero }, config) => {
    ...
    try {
      ...
      if (data[0].id === undefined) {
        mensaje =
          "No hemos encontrado información en el seduvi, por favor verifica los datos ingresados";
      } else {
        mensaje =
  ...
  },
  {
    ...
    schema: z.object({
      ...
      horario: z
        .string()
        .describe(
          "La franja horaria y los dias que tiene disponible el usuario para recibir la visita, dias y franja horaria disponible para ser visitado",
        ),
