...
//     id_seduvi: z.string().describe("ID del seduvi"),
//     id_visita: z.string().describe("ID de la visita"),
//     horario: z.string().describe("Horario de la visita"),
//     observacion: z.string().describe("Observaciones del cliente"),
 
//   });

//   type VisitaProps = z.infer<typeof visitaSchema>;

  


//   /**
//  * Crea una visita en el sistema de gestión de visitas para un cliente.
//  *
//  * @param departamento - El departamento del cliente.
//  * @param piso - El piso del cliente.
//  * @param numero_de_casa - El número de casa del cliente.
//  * @param nombre - El nombre del cliente.
//  * @param id_seduvi - El ID del cliente en el sistema de gestión de visitas.
//  * @param horario - El horario de la visita.
//  * @param observacion - Observaciones adicionales del cliente.
//  * @param id_visita - El ID de la visita (opcional).
//  * 
//  * @returns Una promesa que resuelve con la respuesta de la API de creación de visita.
//  * 
//  */
//   const crearVisita = async ({departamento, piso, numero_de_casa,  nombre, id_seduvi, horario, observacion, id_visita}:VisitaProps) => {
      
        
//         console.log("id seduvi en crear visita", id_seduvi);
//         const prompt = `
...
//           mensaje = "No hemos encontrado información en el seduvi, por favor verifica los datos ingresados"
//         }else{
...
//     const { messages, summary , info_seduvi , info_visita} = state;
...
//       `
//    Eres un asistente virtual de Naturgy enfocado exclusivamente en brindar información sobre el servicio de gas natural residencial. Tu objetivo es ayudar a los usuarios a entender los beneficios del gas natural en el hogar, responder preguntas frecuentes con claridad y ofrecer un acompañamiento confiable, seguro y cercano.
...
//   1. Pregunta de cuánto es la bombona que utiliza actualmente, la de 20kg , 30kg o 45kg.
...
//   - Hola, soy un Agente AI para la contatación de tu suministro de gas Naturgy.
  
//   * Estimación de cuanto te ahorras con el gas natural
//   * Responder preguntas sobre el servicio de gas natural residencial.
//   * Coordinar una visita para la contratación del servicio de gas natural residencial.
